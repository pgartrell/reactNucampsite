...
//mapStateToProps selects the part of the data from the store that the connected component needs
                  ...
                  <CSSTransition key={this.props.location.key} classNames="page" timeout={300}>
                    <Switch>
                        ...
                        <Route exact path='/contactus' render={() => 
                            <Contact resetFeedbackForm={this.props.resetFeedbackForm} postFeedback />} />
